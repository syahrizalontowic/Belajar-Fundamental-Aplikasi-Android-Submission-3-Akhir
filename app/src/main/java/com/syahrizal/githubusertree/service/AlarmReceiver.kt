package com.syahrizal.githubusertree.service
...
import com.syahrizal.githubusertree.ui.activity.MainActivity
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val TYPE_ALARM_REPEATING = "GitHubUserTree"
        const val TYPE_ALARM_ONE_TIME = "SatuWaktuAlarm"
    ...
    fun setRepeatAlarm(context: Context, type: String, time: String) {
        ...
        Toast.makeText(
            context,
            context.getString(R.string.reminder_on) + "$time AM",
            Toast.LENGTH_SHORT
        ).show()
    }
    ...
    private fun showAlarmNotification(context: Context, title: String, notifId: Int) {
        ...
        val builder = NotificationCompat.Builder(context, channelId)
            ...
            .setContentText("Buka Aplikasi Github User!")
